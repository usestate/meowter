...
const configuration = {
  ...
  devtool: mode === 'development' ? 'inline-cheap-module-source-map' : undefined,
  output: {
        ...
        use: [
          {
            loader: 'babel-loader',
            options: {
              plugins: [mode === 'development' && require.resolve('react-refresh/babel')].filter(
                Boolean
              )
            }
          },
  ...
  plugins: [
    ...
    new MiniCssExtractPlugin({
      ...
      filename: mode === 'production' ? 'styles-[contenthash].css' : 'styles.css',
